...
<jsp:include page="/WEB-INF/paginas/clientes/agregarCliente.jsp"></jsp:include>                        

<%--
Este codigo se utilizo para probar que la aplicacion si estaba trayendo la informacion de la base de datos.
<ul>
